...
public class CaptureManagerTools {
    private static final String TAG = CaptureManagerTools.class.getSimpleName();
    ...
    private static String mrawResult, BarcodeFormat;
    ...
    public CaptureManagerTools(Activity activity, DecoratedBarcodeView barcodeView) {
    ...
    public static Intent resultIntent(BarcodeResult rawResult, String barcodeImagePath) {
        ...
        mrawResult = rawResult.toString();
        intent.putExtra(Intents.Scan.RESULT, mrawResult);
        LogUtil.i(TAG, "rawResult.toString() : " + mrawResult);
        BarcodeFormat = rawResult.getBarcodeFormat().toString();
        intent.putExtra(Intents.Scan.RESULT_FORMAT, BarcodeFormat);
    ...
    private void finish() {
        if (!mrawResult.isEmpty()) {
            Intent intent = new Intent(activity, DetailsSampleActivity.class);
            intent.putExtra("qrCode", mrawResult);
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureManagerTools.cameraPermissionReqCode = cameraPermissionReqCode;
    }
